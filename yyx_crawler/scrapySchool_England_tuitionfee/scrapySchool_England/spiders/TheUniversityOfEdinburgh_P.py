...
class TheUniversityofEdinburgh_PSpider(scrapy.Spider):
    name = "TheUniversityofEdinburgh_P"
    # 研究领域链接
    start_urls = ["https://www.ed.ac.uk/studying/postgraduate/degrees/index.php?r=site/taught"]
    ...
    def parse_data(self, response):
        ...
        try:
            ...
            item['teach_time'] = ', '.join(teach_time_re).replace("-", "").lower()
            ...
            start_date = response.xpath(
                "//select[@name='code2']//option//text()|//span[contains(text(),'Start date:')]/../text()").extract()
            ...
            overview = response.xpath(
                "//div[@id='proxy_collapseprogramme']/..").extract()
