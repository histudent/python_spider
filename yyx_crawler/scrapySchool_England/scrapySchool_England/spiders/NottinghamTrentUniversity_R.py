...
class NottinghamTrentUniversity_RSpider(scrapy.Spider):
    name = "NottinghamTrentUniversity_R"
    start_urls = ["https://www.ntu.ac.uk/_resources/funnelback/rests/course-collection-json?level-of-study=Postgraduate%20research&year-of-study=2018&year-of-study=2019&study-option=Full-time&sort=title&start_rank=1"]
    ...
    def parse(self, response):
        ...
        if pagination == "1":
            last_pagination = text_dict.get("resultsPagination").get("totalPages")
            print(last_pagination)
            sr = 1
            for i in range(int(last_pagination)):
                # print("====================", sr)
                url = "https://www.ntu.ac.uk/_resources/funnelback/rests/course-collection-json?level-of-study=Postgraduate%20research&year-of-study=2018&year-of-study=2019&study-option=Full-time&sort=title&start_rank=" + str(sr)
                sr += 10
                print(url)
    ...
    def parse_data(self, response):
        ...
        try:
            ...
            entry_requirements = response.xpath(
                "//div[@id='how-to-apply-1']//h3[contains(text(),'Entry requirements')]/following-sibling::*[1]//text()").extract()
            ...
            apply_proces_en = response.xpath(
                "//div[@id='how-to-apply-1']//h3[contains(text(),'Application process')]/following-sibling::*").extract()
            ...
            tuition_fee = response.xpath("//html//div[@id='fees-and-funding-1']//*[contains(text(),'Full')]/..//text()|//html//div[@id='fees-and-funding-1']//*[contains(text(),'full')]/../..//text()").extract()
