...
class BondUniversity_PSpider(scrapy.Spider):
    name = "BondUniversity_P"
    start_urls = ["https://bond.edu.au/intl/future-students/study-bond/search-program#postgraduate"]


    def parse(self, response):
        links = response.xpath("//div[@id='tab-postgraduate']//ul[@class='links-list']//li/a[contains(text(), 'Master of')]/@href").extract()
        # print(len(links))
        ...
        # 组合字典
        programme_dict = {}
        programme_list = response.xpath("//div[@id='tab-postgraduate']//ul[@class='links-list']//li/a[contains(text(), 'Master of')]//text()").extract()
    ...
    def parse_data(self, response):
        ...
        try:
            type = response.xpath("//strong[contains(text(),'Program type')]/../following-sibling::td//text()").extract()
            print("type: ", type)
            if ''.join(type) != "Master Research":
                ...
                if "Master of " in degree_type:
                    programme = degree_type.replace("Master of ", "").replace("Bachelor of", "").strip()
                ...
                tuition_fee = response.xpath(
                    ...
                    "//strong[contains(text(),'2019 fees:')]/../text()").extract()  # 2019.03.18 星期一
                ...
                entry_requirements = response.xpath(
                    ...
                    "//h4[contains(text(),'English language proficiency requirements')]/preceding-sibling::*").extract()    # 2019.03.18 星期一
                ...
                ielt_desc_dict = {"Doctor of Physiotherapy": "IELTS score 7.0 No sub score less than 7.0",
    "Master of Occupational Therapy": "IELTS score 7.0 No sub score less than 7.0",
    "Master of Psychology (Clinical)": "IELTS score 7.0 No sub score less than 7.0",
    "Doctor of Philosophy": "IELTS score 7.0 No sub score less than 6.5",
    "Master by Research": "IELTS score 7.0 No sub score less than 6.5",
    "Master of Science by Research (Health Sciences)": "IELTS score 7.0 No sub score less than 6.5",
    "Master of Philosophy": "IELTS score 7.0 No sub score less than 6.5",
    "Graduate Certificate in Nutrition": "IELTS score 7.0 No sub score less than 6.5",
    "Graduate Diploma in Nutrition": "IELTS score 7.0 No sub score less than 6.5",
    "Graduate Diploma of Psychological Science": "IELTS score 7.0 No sub score less than 6.5",
    "Master of Architecture": "IELTS score 7.0 No sub score less than 6.5",
    "Master of Nutrition and Dietetic Practice": "IELTS score 7.0 No sub score less than 6.5",
    "Master of Sports Science": "IELTS score 7.0 No sub score less than 6.5",
    "Graduate Certificate in TESOL": "IELTS score 6.5 Writing 6.5, Reading 6.0, Listening 6.0, Speaking 6.0",
    "Graduate Certificate in TESOL (Online)": "IELTS score 6.5 Writing 6.5, Reading 6.0, Listening 6.0, Speaking 6.0",
    "Master of Arts (Coursework)": "IELTS score 6.5 Writing 6.5, Reading 6.0, Listening 6.0, Speaking 6.0",
    "Master of Arts (TESOL)": "IELTS score 6.5 Writing 6.5, Reading 6.0, Listening 6.0, Speaking 6.0",
    "Master of Arts (TESOL) (online)": "IELTS score 6.5 Writing 6.5, Reading 6.0, Listening 6.0, Speaking 6.0",
    "Master of Communication": "IELTS score 6.5 Writing 6.5, Reading 6.0, Listening 6.0, Speaking 6.0",
    "Master of Communication (Professional)": "IELTS score 6.5 Writing 6.5, Reading 6.0, Listening 6.0, Speaking 6.0",
    "Master of Criminology": "IELTS score 6.5 Writing 6.5, Reading 6.0, Listening 6.0, Speaking 6.0",
    "Master of Criminology (Professional)": "IELTS score 6.5 Writing 6.5, Reading 6.0, Listening 6.0, Speaking 6.0",
    "Master of International Relations": "IELTS score 6.5 Writing 6.5, Reading 6.0, Listening 6.0, Speaking 6.0",
    "Master of International Relations (Professional)": "IELTS score 6.5 Writing 6.5, Reading 6.0, Listening 6.0, Speaking 6.0",
    "Master of Building Surveying": "IELTS score 6.5 No sub score less than 6.0",
    "Master of Construction Practice": "IELTS score 6.5 No sub score less than 6.0",
    "Master of Construction Practice (Professional)": "IELTS score 6.5 No sub score less than 6.0",
    "Master of Project Management": "IELTS score 6.5 No sub score less than 6.0",
    "Master of Project Management (Professional)": "IELTS score 6.5 No sub score less than 6.0",
    "Master of Sport Management": "IELTS score 6.5 No sub score less than 6.0",
    "Master of Sport Management (Professional)": "IELTS score 6.5 No sub score less than 6.0",
    "Master of Sustainable Environments and Planning": "IELTS score 6.5 No sub score less than 6.0",
    "Master of Sustainable Environments and Planning (Professional)": "IELTS score 6.5 No sub score less than 6.0",
    "Master of Valuation and Property Development": "IELTS score 6.5 No sub score less than 6.0",
    "Master of Valuation and Property Development (Professional)": "IELTS score 6.5 No sub score less than 6.0",
    "Master of Actuarial Practice": "IELTS score 6.0 No sub score less than 6.0",
    "Master of Actuarial Science": "IELTS score 6.0 No sub score less than 6.0",
    "Master of Actuarial Science (Specialisation)": "IELTS score 6.0 No sub score less than 6.0",
    "Master of Finance": "IELTS score 6.0 No sub score less than 6.0",
    "Master of Finance (Professional)": "IELTS score 6.0 No sub score less than 6.0",
    "Master of Financial Management": "IELTS score 6.0 No sub score less than 6.0",
    "Master of Financial Management (Professional)": "IELTS score 6.0 No sub score less than 6.0",}
                ...
                if "/" not in item['degree_name'] and "online" not in item['degree_name'].lower() and "research" not in item['degree_name'].lower():
                    print("++++++++++++")
                    major_list = response.xpath(
                        "//h2[contains(text(),'Specialist majors')]/following-sibling::div[@role='tablist']/div/div/h4/a//text()|"
                        "//h2[contains(text(),'Specialisations')]/following-sibling::div[@role='tablist']/div/div/h4/a//text()").extract()
                    ...
                    if len(major_list) == 0:
                        ...
                        modules_list = response.xpath(
                            ...
                            "//h2[contains(text(),'Specialisations')]/following-sibling::div[@role='tablist']/div/div[2]").extract()
                        print("===", modules_list)
