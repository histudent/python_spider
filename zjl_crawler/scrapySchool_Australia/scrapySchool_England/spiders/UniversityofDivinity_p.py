...
class UniversityofDivinitySpider(scrapy.Spider):
    name = 'UniversityofDivinity_p'
    allowed_domains = ['divinity.edu.au/']
    start_urls = []
    C= [
        'https://www.divinity.edu.au/study/our-courses/master-biblical-studies/',
        'https://www.divinity.edu.au/study/our-courses/master-church-history/',
        'https://www.divinity.edu.au/study/our-courses/master-of-counselling/',
        'https://www.divinity.edu.au/study/our-courses/master-of-divinity/',
        'https://www.divinity.edu.au/study/our-courses/master-education-theology/',
        'https://www.divinity.edu.au/study/our-courses/master-pastoral-care/',
        'https://www.divinity.edu.au/study/our-courses/master-philosophical-studies/',
        'https://www.divinity.edu.au/study/our-courses/master-spiritual-direction/',
        'https://www.divinity.edu.au/study/our-courses/master-spirituality/',
        'https://www.divinity.edu.au/study/our-courses/mts/',
        'https://www.divinity.edu.au/study/our-courses/master-of-theology-coursework/',
        'https://www.divinity.edu.au/study/our-courses/master-of-philosophy/',
    ]
    # print(len(C))
    for i in C:
        start_urls.append(i)
    def parse(self, response):
        ...
        #7.duration
        duration = response.xpath("//*[contains(text(),'Duration')]//following-sibling::*[1]").extract()
        duration = ''.join(duration)
        duration = remove_tags(duration)
        if 'Eighteen months' in duration:
            duration = '18 months'
            ...
            duration = '2 years'
        elif 'eighteen months' in duration:
            duration = '18 months'
        # print(duration)
