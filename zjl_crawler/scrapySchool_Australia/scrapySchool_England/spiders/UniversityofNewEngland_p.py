...
class UniversityofNewEnglandSpider(scrapy.Spider):
    name = 'UniversityofNewEngland_p'
    allowed_domains = ['une.edu.au/']
    start_urls = []
    C= [
        'https://my.une.edu.au/courses/2019/courses/MCOSC',
        'https://my.une.edu.au/courses/2019/courses/MA',
        'https://my.une.edu.au/courses/2019/courses/MECRD',
        'https://my.une.edu.au/courses/2019/courses/MESCM',
        'https://my.une.edu.au/courses/2019/courses/MED',
        'https://my.une.edu.au/courses/2019/courses/MECCW',
        'https://my.une.edu.au/courses/2019/courses/MDSC',
        'https://my.une.edu.au/courses/2019/courses/MIT',
        'https://my.une.edu.au/courses/2019/courses/MITBUS',
        'https://my.une.edu.au/courses/2019/courses/MIB1',
        'https://my.une.edu.au/courses/2019/courses/MNRG',
        'https://my.une.edu.au/courses/2019/courses/MLAWCW',
        'https://my.une.edu.au/courses/2019/courses/MN',
        'https://my.une.edu.au/courses/2019/courses/MNP',
        'https://my.une.edu.au/courses/2019/courses/MPMNH',
        'https://my.une.edu.au/courses/2019/courses/MPA',
        'https://my.une.edu.au/courses/2019/courses/MSCAG',
        'https://my.une.edu.au/courses/2019/courses/MSW',
        'https://my.une.edu.au/courses/2019/courses/MSCST',
        'https://my.une.edu.au/courses/2019/courses/MTCHPM',
        'https://my.une.edu.au/courses/2019/courses/MTCHSC',
        'https://my.une.edu.au/courses/2019/courses/MURP'
    ]
    # print(len(C))
    for i in C:
        start_urls.append(i)
    def parse(self, response):
        ...
        #12.deadline
        deadline = '2月入学：11月31日；6月入学：5月31日'
        ...
        #25.tuition_fee
        list1 = ['Master of Applied Linguistics',
