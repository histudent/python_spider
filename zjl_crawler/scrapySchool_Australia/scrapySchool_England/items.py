...
class ScrapyschoolEnglandItem1(scrapy.Item):
    ...
    rntry_requirements_cn = scrapy.Field()
    ...
    work_experience_desc_cn = scrapy.Field()
    ...
    apply_desc_cn = scrapy.Field()
    apply_documents_en = scrapy.Field()
    apply_documents_cn = scrapy.Field()
    apply_proces_en = scrapy.Field()
    apply_proces_cn = scrapy.Field()
    other = scrapy.Field()
    url = scrapy.Field()
