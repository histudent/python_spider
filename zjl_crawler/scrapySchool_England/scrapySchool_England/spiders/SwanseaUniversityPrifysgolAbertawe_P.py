...
class SwanseaUniversityPrifysgolAbertawe_PSpider(scrapy.Spider):
    name = "SwanseaUniversityPrifysgolAbertawe_P"
    ...
    def parse_data(self, response):
        ...
        try:
            ...
            # print("item['type_of_degree'] = ", item['type_of_degree'])
...
"MSc Social Research Methods": "College of Human and Health Sciences", }
            ...
            item['require_chinese_en'] = """Postgraduate Programmes:  
Candidates must hold a Bachelor Degree, or its equivalent, from a recognised University/College of Higher Education with a minimum of 2.2 Bachelor: 75% (70% for 211/985) awarded with IELTS 6.5 with 6.0 in each part of the test (or equivalent).

Non-standard grading systems, such as Hong Kong Baptist University (in conjunction with Beijing Normal University, P R China) and SHU-UTS SILC Business School (awarded by University of Technology, Sydney, Australia):

CGPA 2.5/Second Class (Division II) honours"""
            yield item
