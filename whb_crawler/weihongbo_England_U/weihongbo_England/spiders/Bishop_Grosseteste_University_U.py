...
class BaiduSpider(scrapy.Spider):
    name = 'Bishop_Grosseteste_University_U'
    allowed_domains = []
    base_url= '%s'
    start_urls = []
    C = ['https://www.bishopg.ac.uk/course/spomat/',
'https://www.bishopg.ac.uk/course/senthe/',
'https://www.bishopg.ac.uk/course/sendra/',
'https://www.bishopg.ac.uk/course/socdra/',
'https://www.bishopg.ac.uk/course/psyspo/',
'https://www.bishopg.ac.uk/course/psysen/',
'https://www.bishopg.ac.uk/course/psysoc/',
'https://www.bishopg.ac.uk/course/psyecs/',
'https://www.bishopg.ac.uk/course/psycou/',
'https://www.bishopg.ac.uk/course/psydra/',
'https://www.bishopg.ac.uk/course/histhe/',
'https://www.bishopg.ac.uk/course/engpsy/',
'https://www.bishopg.ac.uk/course/enghis/',
'https://www.bishopg.ac.uk/course/engdra/',
'https://www.bishopg.ac.uk/course/eduthe/',
'https://www.bishopg.ac.uk/course/eduspo/',
'https://www.bishopg.ac.uk/course/edusen/',
'https://www.bishopg.ac.uk/course/edusoc/',
'https://www.bishopg.ac.uk/course/edupsy/',
'https://www.bishopg.ac.uk/course/edumat/',
'https://www.bishopg.ac.uk/course/edueng/',
'https://www.bishopg.ac.uk/course/edudra/',
'https://www.bishopg.ac.uk/course/eduhis/',
'https://www.bishopg.ac.uk/course/tesollinguistics/',
'https://www.bishopg.ac.uk/course/sens/',
'https://www.bishopg.ac.uk/course/socs/',
'https://www.bishopg.ac.uk/course/psys/',
'https://www.bishopg.ac.uk/course/primed/',
'https://www.bishopg.ac.uk/course/heas/',
'https://www.bishopg.ac.uk/course/geo/',
'https://www.bishopg.ac.uk/course/edus/',
'https://www.bishopg.ac.uk/course/dram/',
'https://www.bishopg.ac.uk/course/thes/',
'https://www.bishopg.ac.uk/course/engs/',
'https://www.bishopg.ac.uk/course/ecs/',
'https://www.bishopg.ac.uk/course/buss/',
'https://www.bishopg.ac.uk/course/dras/',
'https://www.bishopg.ac.uk/course/babusiness/',
'https://www.bishopg.ac.uk/course/sport/',
'https://www.bishopg.ac.uk/course/hiss/',
'https://www.bishopg.ac.uk/course/archhis/',]
    ...
    def parse(self, response):
        ...
        try:
            ...
            #print(location)
        try:
            department = response.xpath('//*[@id="bgu-single"]/div/article/div/div[1]/div[2]/div/table/tbody/tr[3]/td[2]').extract()[0]
        ...
        try:
            career_en = response.xpath('//div[@class = "cc-careers mrt_30"]').extract()[0]
        ...
        try:
            ib = response.xpath('//*[@id="bgu-single"]/div/article/div/div[3]/div/div').extract()[0]
            ib = remove_tags(ib)
            #print(ib)
        except:
            ib = ''
        ...
        try:
            ...
            #print(alevel)
        try:
            ucascode = response.xpath('//*[@id="bgu-single"]/div/article/div/div[1]/div[2]/div/table/tbody/tr[2]/td[2]').extract()[0]
        ...
        try:
            assessment_en = response.xpath('//*[@id="bgu-single"]/div/article/div/div[7]').extract()[0]
