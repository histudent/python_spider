...
class BaiduSpider(scrapy.Spider):
    name = 'Nova_Soctia_College_of_Arts_and_Design_U'
    allowed_domains = []
    base_url= '%s'
    start_urls = []
    C = ['https://nscad.ca/study-at-nscad/art-history-and-contemporary-culture/',
'https://nscad.ca/study-at-nscad/design/',
'https://nscad.ca/study-at-nscad/craft/',
'https://nscad.ca/study-at-nscad/fine-arts/',
'https://nscad.ca/study-at-nscad/media-arts/',]
