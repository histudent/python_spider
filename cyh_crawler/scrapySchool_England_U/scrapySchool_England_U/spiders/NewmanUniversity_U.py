...
class NewmanuniversityUSpider(scrapy.Spider):
    name = 'NewmanUniversity_U'
    # allowed_domains = ['a.b']
    start_urls = ['https://www.newman.ac.uk/study-level/undergraduate/page/1/']
    def parse(self, response):
        url=['https://www.newman.ac.uk/course/applied-social-science-ba-hons-with-foundation-year/full-time/',
'https://www.newman.ac.uk/course/counselling-studies-and-working-with-children-young-people-and-families-ba-hons/full-time/',
'https://www.newman.ac.uk/course/applied-social-science-ba-hons/full-time/',
'https://www.newman.ac.uk/course/business-economics-ba-hons/full-time/',
'https://www.newman.ac.uk/course/business-and-marketing-ba-hons/full-time/',
'https://www.newman.ac.uk/course/business-management-ba-hons/full-time/',
'https://www.newman.ac.uk/course/drama-and-english-ba-hons-with-foundation-year/drama-and-english-ba-hons-with-foundation-year/',
'https://www.newman.ac.uk/course/accounting-and-finance-ba-hons/full-time/',
'https://www.newman.ac.uk/course/drama-theatre-and-applied-performance-ba-hons/full-time/',
'https://www.newman.ac.uk/course/drama-theatre-and-applied-performance-ba-hons-foundation-year/drama-theatre-and-applied-performance-ba-hons-foundation-year/',
'https://www.newman.ac.uk/course/early-childhood-education-care/full-time/',
'https://www.newman.ac.uk/course/criminology-ba-hons/full-time/',
'https://www.newman.ac.uk/course/drama-and-education-ba-hons/full-time/',
'https://www.newman.ac.uk/course/drama-and-english-ba-hons/full-time/',
'https://www.newman.ac.uk/course/criminology-ba-hons-with-foundation-year/full-time/',
'https://www.newman.ac.uk/course/forensic-psychology-bsc-hons/full-time/',
'https://www.newman.ac.uk/course/english-ba-hons-with-foundation-year-2/english-ba-hons-with-foundation-year-2/',
'https://www.newman.ac.uk/course/english-literature-ba-hons/full-time/',
'https://www.newman.ac.uk/course/english-and-creative-writing-ba-hons-foundation-year/english-and-creative-writing-ba-hons-foundation-year/',
'https://www.newman.ac.uk/course/english-ba-hons/full-time/',
'https://www.newman.ac.uk/course/english-and-education-ba-hons/full-time/',
'https://www.newman.ac.uk/course/education-studies-ba-hons/full-time/',
'https://www.newman.ac.uk/course/education-and-counselling-studies-ba-hons/full-time/',
'https://www.newman.ac.uk/course/physical-education-and-sport-ba-hons-with-foundation-year/full-time/',
'https://www.newman.ac.uk/course/philosophy-religion-education-ba-hons/full-time/',
'https://www.newman.ac.uk/course/sport-and-exercise-science-bsc-hons/full-time/',
'https://www.newman.ac.uk/course/psychology-bsc-hons-with-foundation-year/full-time/',
'https://www.newman.ac.uk/course/sport-and-exercise-psychology-bsc-hons/full-time/',
'https://www.newman.ac.uk/course/sport-and-education-ba-hons/full-time/',
'https://www.newman.ac.uk/course/psychology-bsc-hons/full-time/',
'https://www.newman.ac.uk/course/psychology-and-counselling-studies-ba-hons-with-foundation-year/full-time/',
'https://www.newman.ac.uk/course/psychology-and-childhood-studies-bsc-hons-with-foundation-year/full-time/',
'https://www.newman.ac.uk/course/psychology-and-counselling-studies-bsc-hons/full-time/',
'https://www.newman.ac.uk/course/english-and-creative-writing-ba-hons/full-time/',
'https://www.newman.ac.uk/course/psychology-and-childhood-studies-bsc-hons/full-time/',
'https://www.newman.ac.uk/course/working-with-children-young-people-families-and-education-ba-hons/full-time/',
'https://www.newman.ac.uk/course/working-with-children-young-people-and-families-international-social-work-dual-award/full-time/',
'https://www.newman.ac.uk/course/theology-ba-hons/full-time/',
'https://www.newman.ac.uk/course/studies-in-primary-education/full-time/',
'https://www.newman.ac.uk/course/sport-development-with-coaching-ba-hons-foundation-year/full-time/',
'https://www.newman.ac.uk/course/sport-coaching-science-bsc-hons/full-time/',
'https://www.newman.ac.uk/course/sport-coaching-science-tournament-golf-bsc-hons/full-time/',
'https://www.newman.ac.uk/course/theology-and-education-ba-hons/full-time/',
'https://www.newman.ac.uk/course/working-with-children-young-people-and-families-and-education-ba-hons-with-foundation-year/full-time/',
'https://www.newman.ac.uk/course/working-with-children-young-people-and-families-ba-hons/full-time/',
'https://www.newman.ac.uk/course/sport-exercise-studies-ba-hons/full-time/',
'https://www.newman.ac.uk/course/youth-and-community-work-ba-hons/full-time/',
'https://www.newman.ac.uk/course/history-ba-hons-with-foundation-year/history-ba-hons-with-foundation-year/',
'https://www.newman.ac.uk/course/mathematics-bsc-hons/full-time/',
'https://www.newman.ac.uk/course/history-ba-hons/full-time/',
'https://www.newman.ac.uk/course/health-and-social-care-bsc-hons-with-foundation-year/full-time/',
'https://www.newman.ac.uk/course/forensic-psychology-bsc-hons-with-foundation-year-2/forensic-psychology-bsc-hons-with-foundation-year-2/',
'https://www.newman.ac.uk/course/history-and-education-ba-hons/full-time/',
'https://www.newman.ac.uk/course/health-and-social-care-bsc-hons/full-time/',
'https://www.newman.ac.uk/course/counselling-studies-and-working-with-children-young-people-and-families-ba-hons-with-foundation-year/full-time/',]
        url=set(url)
        for u in url:
    ...
    def parsesss(self, response):
        ...
        print(response.url)
        alevel=response.xpath('//h2[text()="Entry Requirements"]/following-sibling::p[contains(text(),"A Level")]/text()').extract()
        if alevel==[]:
            alevel=response.xpath('//h2[text()="Entry Requirements"]/following-sibling::p[contains(text(),"UCAS")]/text()').extract()
        # print(alevel)
    ...
    def parses(self,response):
        ...
        # modules = response.xpath('//h2[contains(text(),"odules")]/..').extract()
        ...
        ucascode=response.xpath('//span[contains(text(),"Course Code")]/preceding-sibling::span/text()').extract()
        ucascode=''.join(ucascode).strip()
        # print(ucascode)
        item['ucascode']=ucascode

        apply_preces=['<div  class="asset-wrapper asset aid-921 asset-accordion"><ul class="accordion accordion--clear">',
