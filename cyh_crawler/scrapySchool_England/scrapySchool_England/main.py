...
# cmdline.execute('scrapy crawl zhuanye'.split())
...
# cmdline.execute('scrapy crawl BirkbeckUniversityOfLondon_P'.split())

# cmdline.execute('scrapy crawl WrexhamGlyndwrUniversity_P'.split())
# cmdline.execute('scrapy crawl BuckinghamshireNewUniversity_P'.split())