...
class ScrapyschoolCanadaBenPipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        insert_sql = "insert into tmp_school_ca_ben(school_name,location,campus,major_type1,department," \
                     ...
                     "is_huikao_score,other,url,gatherer,batch_number,finishing,update_time,import_status,specific_requirement_en) values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
        ...
        try:
            ...
            self.count += 1
            self.cursor.execute(insert_sql, (item["school_name"],item["location"],item["campus"],item["major_type1"],item["department"],
                                 ...
                                 item["batch_number"],item["finishing"],item["update_time"],item["import_status"],item["specific_requirement_en"]))
            self.db.commit()
            print("数据插入成功")
