...
class AstonUniversity_PSpider(scrapy.Spider):
    name = "AstonUniversity_P"
    start_urls = ['http://w01.aston.ac.uk/data/core/content/courses.j2d?types[]=pg&types[]=mba']
    ...
    def parse(self, response):
        ...
        for d in data_dict:
            ...
            if 'full' in mode.lower():
                ...
                # print("mode: ", mode)
                # print("---",url)
                l = ["http://www.aston.ac.uk/aston-business-school/programmes/aston-mba/full-time-mba/",
"http://www.aston.ac.uk/study/postgraduate/taught-programmes/life-health-sciences/pharmacy-msccourses/",
"http://www.aston.ac.uk/study/postgraduate/taught-programmes/life-health-sciences/pharmacy-msccourses/",
"http://www.aston.ac.uk/study/postgraduate/taught-programmes/life-health-sciences/pharmacy-msccourses/", ]
                for url in l:
    ...
    def parse_data(self, response):
        ...
        try:
            ...
            tuition_fee_re = re.findall(r"International.*?£\d+,\d+|non-EU.*?£\d+,\d+|MSc.*?£\d+,\d+|entry:£\d+,\d+|2018/2019:£\d+,\d+|£\d+,\d+\sfor\sOutside\sEU", tuition_fee_str, re.I)
...
"health psychology (on campus) - msc",]
            ...
            if item['department'] == "Life & Health Sciences - OSPAP":
                ...
                item['ielts_r'] = 7
                item['ielts_w'] = 7
            elif 'electrical' in item['programme_en'].lower() or 'engineering' in item['programme_en'].lower():
                item['ielts'] = 6
                item['ielts_l'] = 5.5
                item['ielts_s'] = 5.5
                item['ielts_r'] = 5.5
